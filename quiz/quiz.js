...
/**
 * Update question and answers to DOM based on currentQuestion value.
 */
function updateQuestion() {
    ...
    // Set current question text to quoestionEl textContent
    questionEl.textContent = questions[currentQuestion].question;

    // Loop trough answers and create answer li elements
...
function finalVerdict() {
    ...
    for (var i in verdicts) {
        // Check if score is enought for this verdict
